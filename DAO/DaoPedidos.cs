...
namespace DAO
{
    public class DaoPedidos
    {
        ...
        public DataTable getTablaPedidos()
        {
            ...
            DataTable tabla = ds.ObtenerTabla("Pedidos", "select CodPed as 'Id Pedido', IdCliente 'Id Cliente', Fecha_Entrega as 'Fecha de Entrega' from Pedidos where Estado = 1");
            return tabla;
        }
        ...
        {
            List<Pedidos> lista = new List<Pedidos>();
            DataTable tabla = ds.ObtenerTabla("Pedidos", "select CodPed as 'Id Pedido', IdCliente 'Id Cliente', Fecha_Entrega as 'Fecha de Entrega' from Pedidos");
            return tabla;
        }
        ...
        {
            List<Pedidos> lista = new List<Pedidos>();
            DataTable tabla = ds.ObtenerTabla("Pedidos", "select CodPed as 'Id Pedido', IdCliente 'Id Cliente' from Pedidos where Estado = 1");
            return tabla;
        }
    }
}
